...
-- 1️⃣ Tabela Autenticacao (para armazenar logins/senhas)
CREATE TABLE Autenticacao (
    ID_Autenticacao INTEGER PRIMARY KEY,
    Senha VARCHAR(20),
    Login VARCHAR(100),
    email VARCHAR(100)
);

-- 2️⃣ Tabela Estado_Civil (não depende de nenhuma outra)
CREATE TABLE Estado_Civil (
    ID_Estado_Civil INTEGER PRIMARY KEY,
    Desc_Estado_Civil VARCHAR(50)
);

-- 3️⃣ Tabela Forma_Pagamento (não depende de nenhuma outra)
CREATE TABLE Forma_Pagamento (
    ID_Forma_Pagamento INTEGER PRIMARY KEY,
    Desc_Forma_Pgto VARCHAR(50)
);

-- 4️⃣ Tabela Locador (depende de Estado_Civil)
...
-- 5️⃣ Tabela Locatario (depende de Estado_Civil)
...
-- 6️⃣ Tabela Imovel (depende de Locador)
CREATE TABLE Imovel (
...
-- 7️⃣ Tabela Contrato (depende de Imovel, Locador e Locatario)
...
-- 8️⃣ Tabela Registro_Pagamento (depende de Contrato, Locatario e Forma_Pagamento)
